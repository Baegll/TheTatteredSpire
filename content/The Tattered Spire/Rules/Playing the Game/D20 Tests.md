...
1. **Roll 1d20.** You always want to roll high. If the roll has [[#Advantage/Disadvantage|Advantage]] or [[#Advantage/Disadvantage|Disadvantage]] (described later in “[[#Advantage/Disadvantage]]”), you roll two d20s, but you use the number from only one of them—the higher one if you have [[#Advantage/Disadvantage|Advantage]] or the lower one if you have [[#Advantage/Disadvantage|Disadvantage]].
...
1. **Compare the Total to a Target Number.** If the total of the d20 and its modifiers equals or exceeds the target number, the D20 Test succeeds. Otherwise, it fails. The Game Master determines target numbers and tells players whether their rolls are successful. The target number for an ability check or a saving throw is called a [[#Difficulty Class]] (DC). The target number for an attack roll is called an [[#Armor Class]] (AC), which appears on a character sheet or in a stat block (see “[[Rules Glossary]]”).
...
#### Ability Modifier
An ability check is named for the ability modifier it uses: a [[The Six Abilities|Strength]] check, an [[The Six Abilities|Intelligence]] check, and so on. Different ability checks are called for in different situations, depending on which ability is most relevant. See the Ability Check Examples table for examples of each check’s use.
#### Table: Ability Check Examples

| [[The Six Abilities\|Ability]] | Make a Check To …                                          |
| ------------------------------ | ---------------------------------------------------------- |
...
#### Proficiency Bonus
Add your Proficiency Bonus to an ability check when the GM determines that a skill or tool proficiency is relevant to the check and you have that proficiency. For example, if a rule refers to a [[The Six Abilities|Strength]] ([[Proficiency#Skill Proficiencies|Acrobatics]] or [[Proficiency#Skill Proficiencies|Athletics]]) check, you can add your Proficiency Bonus to the check if you have proficiency in the [[Proficiency#Skill Proficiencies|Acrobatics]] or [[Proficiency#Skill Proficiencies|Athletics]] skill. See “[[Proficiency]]” later in “Playing the Game” for more information about skill and tool proficiencies.
#### Difficulty Class
...
| [[The Six Abilities\|Ability]] | Make a Save To …               |
| ------------------------------ | ------------------------------ |
...
### Attack Rolls
An attack roll determines whether an attack hits a target. An attack roll hits if the roll equals or exceeds the target’s [[#Armor Class]]. Attack rolls usually occur in battle, described in “[[Combat]]” in “Playing the Game,” but the GM might also ask for an attack roll in other situations, such as an archery competition.
#### Ability Modifier
...
| [[The Six Abilities\|Ability]] | Attack Type                                                                                                           |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
...
Some features let you use different ability modifiers from those listed. For example, the [[Finesse]] property (see “[[Equipment]]”) lets you use [[The Six Abilities|Strength]] or [[The Six Abilities|Dexterity]] with a weapon that has that property.
#### Proficiency Bonus
...
#### Rolling 20 or 1
If you roll a 20 on the d20 (called a “natural 20”) for an attack roll, the attack hits regardless of any modifiers or the target’s AC. This is called a [[Damage and Healing#Critical Hits|Critical Hits]] (see “[[Combat]]” or "[[Damage and Healing]]" later in “Playing the Game”).

If you roll a 1 on the d20 (a “natural 1”) for an attack roll, the attack misses regardless of any modifiers or the target’s AC. This is called a [[Critical Miss]].
...
#### Roll Two D20s
When a roll has either [[#Advantage/Disadvantage|Advantage]] or [[#Advantage/Disadvantage|Disadvantage]], roll a second d20 when you make the roll. Use the higher of the two rolls if you have [[#Advantage/Disadvantage|Advantage]], and use the lower roll if you have [[#Advantage/Disadvantage|Disadvantage]]. For example, if you have [[#Advantage/Disadvantage|Disadvantage]] and roll an 18 and a 3, use the 3. If you instead have [[#Advantage/Disadvantage|Advantage]] and roll those numbers, use the 18.
#### They Don’t Stack
If multiple situations affect a roll and they all grant [[#Advantage/Disadvantage|Advantage]] on it, you still roll only two d20s. Similarly, if multiple situations impose [[#Advantage/Disadvantage|Disadvantage]] on a roll, you roll only two d20s.

If circumstances cause a roll to have both [[#Advantage/Disadvantage|Advantage]] and [[#Advantage/Disadvantage|Disadvantage]], the roll has neither of them, and you roll one d20. This is true even if multiple circumstances impose [[#Advantage/Disadvantage|Disadvantage]] and only one grants [[#Advantage/Disadvantage|Advantage]] or vice versa. In such a situation, you have neither [[#Advantage/Disadvantage|Advantage]] nor [[#Advantage/Disadvantage|Disadvantage]].
#### Interactions with Rerolls
When you have [[#Advantage/Disadvantage|Advantage]] or [[#Advantage/Disadvantage|Disadvantage]] and something in the game lets you reroll or replace the d20, you can reroll or replace only one die, not both. You choose which one.

For example, if you have Heroic Inspiration (see the sidebar below) and roll a 3 and an 18 on an ability check that has [[#Advantage/Disadvantage|Advantage]] or [[#Advantage/Disadvantage|Disadvantage]], you could expend your Heroic Inspiration to reroll one of those dice, not both of them.