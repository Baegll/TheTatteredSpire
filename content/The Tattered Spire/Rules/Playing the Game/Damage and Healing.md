...
> Resting
>
> Adventurers can’t spend every hour adventuring. They need rest. Regaining Hit Points is one of the main benefits of a rest. “[[Rules Glossary]]” provides the rules for [[Short Rest|Short]] and [[Long Rest|Long Rests]].
### Damage Rolls
...
### Critical Hits
When you score a Critical Hit, you deal extra damage. Roll the attack’s damage dice once, but add the maximum flat damage of the dice on top, and add any relevant modifiers as normal. For example, if you score a Critical Hit with a [[Dagger]], roll 1d4+4 for the damage rather than 1d4, and add your relevant ability modifier. This applies if your weapon deals multiple dice damage, such as the [[Greatsword]], roll 2d6+12 for the damage rather than just 2d6. If the attack involves other damage dice, such as from the [[Rogue#Level 1 Sneak Attack|Rogue's Sneak Attack]] feature, you do not add flat damage from those features, however they do benefit from [[#Cascading Explosions Cascading|Cascading]].
#### [[Cascading Explosions|Cascading]]
In addition, dice on a critical hit are [[Cascading Explosions|cascading]]. This means, when you roll the biggest number on a die, also roll the next-smallest die and add that to your roll. This can keep going all the way down to d4. Rolling a 4 on a d4 has nowhere left to go, but good job on your massive roll! A table explaining the dice further is in the [[Cascading Explosions#Table: Dice Values|Dice Values]]
...
### Damage Types
Each instance of damage has a type, like [[Fire]] or [[Slashing]]. Damage types are listed in “[[Rules Glossary]]” and have no rules of their own, but other rules, such as [[#Resistance and Vulnerability|Resistance]], rely on damage types.
...
### Healing
Hit Points can be restored by magic, such as the *Cure Wounds* or by a *Potion of Healing*,  spell or a [[Short Rest|Short]] or [[Long Rest]] (see “[[Rules Glossary]]”).
...
**Monster Death.** A monster dies the instant it drops to 0 Hit Points, although a Game Master can ignore this rule for an individual monster and treat it like a character. In addition, some monsters may have a feature or trait which causes them to not instantly die at 0 Hit Points.
...
You can take the Help action to try to stabilize a creature with 0 Hit Points, which requires a successful DC 10 [[The Six Abilities|Wisdom]] ([[Proficiency#Skill Proficiencies|Medicine]]) check.
