...
#### Obscured Areas
An area might be Lightly or Heavily Obscured. In a Lightly Obscured area—such as an area with Dim Light, patchy fog, or moderate foliage—you have [[D20 Tests#Advantage/Disadvantage|Disadvantage]] on [[The Six Abilities|Wisdom]] ([[Proficiency#Skill Proficiencies|Perception]]) checks that rely on sight.

A Heavily Obscured area—such as an area with Darkness from the *[[Darkness]]* spell, heavy fog, or dense foliage—is opaque. You have the [[Blinded]] condition (see “[[Rules Glossary]]”) when trying to see something there.
#### Light
...
**Fast.** Traveling at a Fast pace imposes [[D20 Tests#Advantage/Disadvantage|Disadvantage]] on a traveler’s [[The Six Abilities|Wisdom]] ([[Proficiency#Skill Proficiencies|Perception]] or [[Proficiency#Skill Proficiencies|Survival]]) and [[The Six Abilities|Dexterity]] ([[Proficiency#Skill Proficiencies|Stealth]]) checks.
