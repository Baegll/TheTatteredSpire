...
| [[Proficiency#Skill Proficiencies\|Skill Proficiencies]] | Choose 2: Arcana, Deception, History, Intimidation, Investigation, Nature, or Religion                                                 |
...
When you gain certain Warlock levels, you gain more invocations of your choice, as shown in the Invocations column of the [[#Table Warlock Features|Warlock Features table]].
...
**Spellcasting Ability.** [[The Six Abilities|Charisma]] is the spellcasting ability for your Warlock spells.
...
Your patron grants you a magical secret called an arcanum. Choose one [[#Table Level 6 Warlock Spells|level 6 Warlock spell]] as this arcanum.
...
As shown in the Warlock Features table, you gain another Warlock spell of your choice that can be cast in this way when you reach Warlock levels 13 ([[#Table Level 7 Warlock Spells|level 7 spell]]), 15 ([[#Table Level 8 Warlock Spells|level 8 spell]]), and 17 ([[#Table Level 9 Warlock Spells|level 9 spell]]). You regain all uses of your Mystic Arcanum when you finish a Long Rest.
...
Choose one of your known Warlock cantrips that deals damage. You can add your [[The Six Abilities|Charisma]] modifier to that spell's damage rolls.
...
You can see normally in [[Exploration#Light|Dim Light and Darkness]] both magical and nonmagical—within 120 feet of yourself.
#### Devouring Blade
...
#### Eldritch Mind
You have [[D20 Tests#Advantage/Disadvantage|Advantage]] on [[The Six Abilities|Constitution]] saving throws that you make to maintain [[Concentration]].
#### Eldritch Smite
...
Choose one of your known [[#Table Cantrips (Level 0 Warlock Spells)|Warlock cantrips]] that deals damage and has a range of 10+ feet. When you cast that spell, its range increases by a number of feet equal to 30 times your Warlock level.

**Repeatable.** You can gain this invocation more than once. Each time you do so, choose a different eligible cantrip.
#### Fiendish Vigor
*Prerequisite: Level 2+ Warlock*

You can cast *[[False Life]]* on yourself without expending a spell slot. When you cast the spell with this feature, you don't roll the die for the [[Damage and Healing#Temporary Hit Points|Temporary Hit Points]]; you automatically get the highest number on the die.
#### Gaze of Two Minds
*Prerequisite: Level 5+ Warlock*

You can use a [[Actions#Bonus Actions|Bonus Action]] to touch a willing creature and perceive through its senses until the end of your next turn. As long as the creature is on the same plane of existence as you, you can take a [[Actions#Bonus Actions|Bonus Action]] on subsequent turns to maintain this connection, extending the duration until the end of your next turn. The connection ends if you don't maintain it in this way.
...
A new page appears in your *Book of Shadows* when you conjure it. With your permission, a creature can take an action to write its name on that page, which can contain a number of names equal to your [[The Six Abilities|Charisma]] modifier (minimum of one name).

When any creature whose name is on the page is reduced to 0 [[Damage and Healing#Hit Points|Hit Points]] but not killed outright, the creature magically drops to 1 [[Damage and Healing#Hit Points|Hit Point]] instead. Once this magic is triggered, no creature can benefit from it until you finish a [[Long Rest]].

As a [[Actions#Table Actions|Magic action]], you can erase a name on the page by touching it.
...
**Quick Attack.** As a [[Actions#Bonus Actions|Bonus Action]], you can command the familiar to take the [[Actions#Table Actions|Attack action]].
...
**Resistance.** When the familiar takes damage, you can take a [[Actions#Reactions|Reaction]] to grant it [[Damage and Healing#Resistance and Vulnerability|Resistance]] against that damage.
...
Once per turn when you hit a creature with your pact weapon, you can deal an extra 1d6 [[Necrotic]], [[Psychic]], or [[Radiant]] damage (your choice) to the creature, and you can expend one of your Hit Point Dice to roll it and regain a number of [[Damage and Healing#Hit Points|Hit Points]] equal to the roll plus your [[The Six Abilities|Constitution]] modifier (minimum of 1 Hit Point).
#### Mask of Many Faces
*Prerequisite: Level 2+ Warlock*
...
While you're in an area of [[Exploration#Light|Dim Light or Darkness]], you can cast *[[Invisibility]]* on yourself without expending a spell slot.
#### Otherworldly Leap
*Prerequisite: Level 2+ Warlock*

You can cast *[[Jump]]* on yourself without expending a spell slot.
#### Pact of the Blade
As a [[Actions#Bonus Actions|Bonus Action]], you can conjure a pact weapon in your hand—a [[Simple]] or [[Martial]] [[Melee weapon]] of your choice with which you bond—or create a bond with a magic weapon you touch; you can't bond with a magic weapon if someone else is attuned to it or another Warlock is bonded with it. Until the bond ends, you have proficiency with the weapon, and you can use it as a [[Spellcasting Focus]].

Whenever you attack with the bonded weapon, you can use your [[The Six Abilities|Charisma]] modifier for the attack and damage rolls instead of using [[The Six Abilities|Strength]] or [[The Six Abilities|Dexterity]]; and you can cause the weapon to deal [[Necrotic]], [[Psychic]], or [[Radiant]] damage or its normal damage type.

Your bond with the weapon ends if you use this feature's [[Actions#Bonus Actions|Bonus Action]] again, if the weapon is more than 5 feet away from you for 1 minute or more, or if you die. A conjured weapon disappears when the bond ends.
#### Pact of the Chain
You learn the *[[Find Familiar]]* spell and can cast it as a [[Actions#Table Actions|Magic action]] without expending a spell slot.
...
Additionally, when you take the [[Actions#Table Actions|Attack action]], you can forgo one of your own attacks to allow your familiar to make one attack of its own with its [[Actions#Reactions|Reaction]].
#### Pact of the Tome
Stitching together strands of shadow, you conjure forth a book in your hand at the end of a [[Short Rest|Short]] or [[Long Rest]]. This *Book of Shadows* (you determine its appearance) contains eldritch magic that only you can access, granting you the benefits below. The book disappears if you conjure another book with this feature or if you die.

**Cantrips and Rituals.** When the book appears, choose three [[#Table Cantrips (Level 0 Warlock Spells)|cantrips]], and choose two [[#Table Level 1 Warlock Spells|level 1 spells]] that have the [[Ritual]] tag. The spells can be from any class's spell list, and they must be spells you don't already have prepared. While the book is on your person, you have the chosen spells prepared, and they function as Warlock spells for you.

**Spellcasting Focus.** You can use the book as a [[Spellcasting Focus]].
#### Repelling Blast
*Prerequisite: Level 2+ Warlock, a Warlock Cantrip That Deals Damage via an Attack Roll*

Choose one of your known [[#Table Cantrips (Level 0 Warlock Spells)|Warlock cantrips]] that requires an attack roll. When you hit a [[Large]] or smaller creature with that cantrip, you can push the creature up to 10 feet straight away from you.

**Repeatable.** You can gain this invocation more than once. Each time you do so, choose a different eligible cantrip.
#### Thirsting Blade
*Prerequisite: Level 5+ Warlock, Pact of the Blade Invocation*

You gain the Extra Attack feature for your pact weapon only. With that feature, you can attack twice with the weapon instead of once when you take the [[Actions#Table Actions|Attack action]] on your turn.
