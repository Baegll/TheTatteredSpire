...
| [[Proficiency#Skill Proficiencies\|Skill Proficiencies]] | Choose 2: Athletics, Insight, Intimidation, Medicine, Persuasion, or Religion                                     |
...
Your blessed touch can heal wounds. You have a pool of healing power that replenishes when you finish a [[Long Rest]]. With that pool, you can restore a total number of [[Damage and Healing#Hit Points]] equal to five times your Paladin level.

As a [[Actions#Bonus Actions|Bonus Action]], you can touch a creature (which could be yourself) and draw power from the pool of healing to restore a number of [[Damage and Healing#Hit Points|Hit Points]] to that creature, up to the maximum amount remaining in the pool.
...
**Spellcasting Ability.** [[The Six Abilities|Charisma]] is your spellcasting ability for your Paladin spells.

**Spellcasting Focus.** You can use a [[Holy Symbol]] as a [[Spellcasting Focus]] for your Paladin spells.
#### Level 1: Weapon Mastery
Your training with weapons allows you to use the [[mastery properties]] of two kinds of weapons of your choice with which you have proficiency, such as [[Longsword|Longswords]] and [[Javelin|Javelins]].
...
**Divine Sense.** As a [[Actions#Bonus Actions|Bonus Action]], you can open your awareness to detect [[Celestial|Celestials]], [[Fiend|Fiends]], and [[Undead]]. For the next 10 minutes or until you have the [[Incapacitated]] condition, you know the location of any creature of those types within within 60 feet of you that is not behind total cover, and you know its creature type. Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the *[[Hallow]]* spell.
### Breaking Your Oath
...
You and your allies in the aura gain a bonus to saving throws equal to your [[The Six Abilities|Charisma]] modifier (minimum bonus of +1).

If another Paladin is present, a creature can benefit from only one Aura of Protection at a time; the creature chooses which aura while in them.
#### Level 9: Abjure Foes
As a [[Actions#Table Actions|Magic action]], you can expend one use of this class's Channel Divinity to overwhelm foes with awe. As you present your [[Holy Symbol]] or weapon, you can target a number of creatures equal to your [[The Six Abilities|Charisma]] modifier (minimum of one creature) that you can see within 60 feet of yourself. Each target must succeed on a [[The Six Abilities|Wisdom]] saving throw or have the [[Frightened]] condition for 1 minute or until it takes any damage. While [[Frightened]] in this way, a target can do only one of the following on its turns: move, take an action, or take a [[Actions#Bonus Actions|Bonus Action]].
#### Level 10: Aura of Courage
You and your allies have Immunity to the [[Frightened]] condition while in your [[#Level 6 Aura of Protection|Aura of Protection]]. If a [[Frightened]] ally enters the aura, that condition has no effect on that ally while there.
#### Level 11: Radiant Strikes
Your strikes now carry supernatural power. When you hit a target with an attack roll using a [[Melee weapon]] or an [[Unarmed Strike]], the target takes an extra 1d8 [[Radiant]] damage.
#### Level 14: Restoring Touch
When you use [[#Level 1 Lay On Hands|Lay On Hands]] on a creature, you can also remove one or more of the following conditions from the creature: [[Blinded]], [[Charmed]], [[Deafened]], [[Frightened]], [[Paralyzed]], or [[Stunned]]. You must expend 5 Hit Points from the healing pool of Lay On Hands for each of these conditions you remove; those points don't also restore [[Damage and Healing#Hit Points|Hit Points]] to the creature.
