...
#### Write Your Level
Characters in The Tattered Spire will start at level 3.
...
- Do they worship a deity? 
	- Who?
	- Why/Why not?
	- If they do, are they from the [[The Panathejor|Panathejor]] or [[The Panathedim|Panathedim]]
- What elements of your past inspire you to go on adventures now?
- [[Diveneu]] is a city of possiblity, what are they currently searching for?
#### Choose Languages
Your character knows at least three languages: [[Common]] plus two languages you roll or choose from the [[#Table Standard Languages|Standard Langauges table]]. Knowledge of a language means your character can communicate in it, read it, and write it. Your class and other features might also give you languages.

The [[#Table Standard Languages|Standard Langauges table]] lists languages that are widespread in the setting. Every player character knows [[Common]]. The other standard languages originated with the first members of the most prominent species in the setting and have since spread widely.
...
To determine your character's ability scores, you first generate a set of six numbers using the instructions below and then assign them to your six abilities. "[[The Six Abilities]]" explains what each ability means.
#### Generate Your Scores
**Standard Array.** Use the following six scores for your abilities: 15, 14, 13, 12, 10, 8.
#### Assign Ability Scores
Once you've generated [[The Six Abilities|six scores]], assign them to Strength, Dexterity, Constitution, Intelligence, Wisdom, and Charisma, keeping in mind your class's primary ability. Fill in the ability modifiers as well.

If you're using the Standard Array option, consult the [[#Table Standard Array by Class| Standard Array by Class table]] for suggestions on where to assign scores for your character's class. The table puts the highest scores in a class's main abilities. If you used a different method to generate the scores, you may still use this table to guide where you place your highest and lowest scores.
...
2. **Adjust Hit Points and Hit Point Dice.** Each time you gain a level, you gain an additional Hit Die. To adjust your maximum hp, Instead of rolling, you will use the fixed value shown in the Fixed Hit Points by Class table.
...
### **Starting Equipment**
Characters starting at level 3 do not gain any extra equipment in The Tattered Spire.
## Multiclassing
